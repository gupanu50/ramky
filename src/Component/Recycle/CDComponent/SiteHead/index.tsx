...
const DashboardSiteHead = (props: any) => {
  ...
  const collectionTrendApi = async (date, date1, date2) => {
    ...
    //     const params={start:previousDay,end:time1,siteName:city};
    // const result =
    //   await ApiClient.createApiClient().recyclesiteheadcollectiontrend(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
  ...
  const productTrendApi = async (date, date1, date2) => {
    ...
    //     const params={start:previousDay,end:time1,siteName:city};
    // const result =
    //   await ApiClient.createApiClient().recyclesiteheadproducttrend(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const processedTrendApi = async (date, date1, date2) => {
    ...
    //     const params={start:previousDay,end:time1,siteName:city};
    // const result =
    //   await ApiClient.createApiClient().recyclesiteheadprocesstrend(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const collectedWasteLeftMenuApi = async (date5, date6, date2) => {
    ...
    //     const params={start:previousDay,end:time1,siteName:city};
    // const result =
    //   await ApiClient.createApiClient().recyclecdSiteHeadCollection(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
