...
const DashboardSiteHead = (props: any) => {
  ...
  const postWastedSummaryApi = async (date, date1, date2) => {
    ...
    // @ts-ignore 
    const result = await ApiClient.createApiClient().siteHeadWasteSummary(params);
    // @ts-ignore 
    if (result.status && result.data.status === true) {
      // @ts-ignore 
  ...
  const CollectiontrendApi = async (date, date1, date2) => {
    ...
    const result = await ApiClient.createApiClient().siteHeadCollectedGraph(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const Processedtrendgraph = async (date, date1, date2) => {
    ...
    const result = await ApiClient.createApiClient().siteHeadProcessedGraph(params);
  ...
  const Segregatedtrendgraph = async (date, date1, date2) => {
    ...
    const result = await ApiClient.createApiClient().siteHeadSegregatedGraph(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
...
// eslint-disable-next-line no-unused-vars
  const postWastedProcessedApi = async (date, date1, date2) => {
    ...
    const result = await ApiClient.createApiClient().siteHeadProcessedSummary(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
  ...
  const postproductsummaryapi = async (date, date1, date2) => {
    ...
    const result = await ApiClient.createApiClient().siteHeadProductSummary(params);
    // @ts-ignore
...
// eslint-disable-next-line no-unused-vars
  const collectedWasteLeftMenuApi = async (date5, date6, date2) => {
    ...
    const result = await ApiClient.createApiClient().siteHeadCollection(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const segregationWasteLeftMenuApi = async (date7, date8, date2) => {
    ...
    const result = await ApiClient.createApiClient().siteHeadSegregation(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const processedWasteLeftMenuApi = async (date9, date10, date2) => {
    ...
    const params = {start:previousDay,end:time1,siteName:city};
    const result = await ApiClient.createApiClient().siteHeadProcessed(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const historyApi = async (date3, date4, date2) => {
    ...
    const params = {start:previousDay,end:time1,siteName:city}
    const result = await ApiClient.createApiClient().siteHeadHistory(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
