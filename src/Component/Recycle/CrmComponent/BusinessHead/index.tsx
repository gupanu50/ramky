...
const DashboardBusinessHead = (props: any) => {
  ...
  const historyApi = async (date3, date4, date2) => {
    ...
    // setLoading(true);
    const result = await ApiClient.createApiClient().recyclecrmbusinessheadhistory(params);
    // @ts-ignore
    ...
    RNFS.writeFile(path + '/recycle_crm_business_history_data_' + new Date().getTime() + '.xlsx', wbout, 'ascii').then(() => {
      {
        Platform.OS === 'android' ?
          ...
          Toast.show("Excel File Is Downloaded Successfully",Toast.SHORT,25,50);
      }
    }).catch((e) => {
      console.log('Error', e);
    });
  ...
  const collectionTrendApi = async (date, date1, date2) => {
    ...
    const params ={start:previousDay,end:time1,siteName:city};
    // setLoading(true);
    const result = await ApiClient.createApiClient().recyclecrmbusinessheadcollectiontrendgraph(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const processedTrendApi = async (date, date1, date2) => {
    ...
    const params ={start:previousDay,end:time1,siteName:city};
    // setLoading(true);
    const result = await ApiClient.createApiClient().recyclecrmbusinessheadprocesstrendgraph(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const segregatedTrendApi = async (date, date1, date2) => {
    ...
    const params ={start:previousDay,end:time1,siteName:city};
    // setLoading(true);
    const result = await ApiClient.createApiClient().recyclecrmbusinessheadsegregatedtrendgraph(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const wasteSummaryApi = async (date, date1, date2) => {
    ...
    // const params ={start:previousDay,end:time1,siteName:city};
    // const result = await ApiClient.createApiClient().recyclecrmbusinessheadmaterialsummary(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
  ...
  const processedSummaryApi = async (date, date1, date2) => {
    ...
    // const params ={start:previousDay,end:time1,siteName:city};
    // const result = await ApiClient.createApiClient().recyclecrmbusinessheadprocessedsummary(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
  ...
  const productSummaryApi = async (date, date1, date2) => {
    ...
    // const params ={start:previousDay,end:time1,siteName:city};
    // const result = await ApiClient.createApiClient().recyclecrmbusinessheadproductionsummary(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
  ...
  const collectedWasteLeftMenuApi = async (date5, date6, date2) => {
    ...
    // const params ={start:previousDay,end:time1,siteName:city};
    // const result = await ApiClient.createApiClient().recyclecrmBusinessHeadnavbarCollection(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const segregationWasteLeftMenuApi = async (date7, date8, date2) => {
    ...
    // const params ={start:previousDay,end:time1,siteName:city};
    // const result = await ApiClient.createApiClient().recyclecrmBusinessHeadnavbarsegregated(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const processedWasteLeftMenuApi = async (date9, date10, date2) => {
    ...
    // const params ={start:previousDay,end:time1,siteName:city};
    // const result = await ApiClient.createApiClient().recyclecrmBusinessiteHeadnavbarprocessed(params);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
